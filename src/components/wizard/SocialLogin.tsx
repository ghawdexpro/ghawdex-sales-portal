  ...
  return (
    <div className="mb-6">
      ...
      <div className="text-center mb-4">
        <span className="text-sm text-gray-400">Quick fill with your account</span>
      </div>
        ...
        {hasGoogle && (
          <div className="flex justify-center">
            {googleLoaded ? (
              ...
              <button
                disabled
                className="w-full max-w-[280px] flex items-center justify-center gap-3 bg-white/5 border border-white/20 rounded-lg py-3 px-4 text-gray-400"
              >
        ...
        {hasFacebook && (
          <div className="flex justify-center">
            <button
              ...
              className="w-full max-w-[280px] flex items-center justify-center gap-3 bg-[#1877F2] hover:bg-[#166fe5] disabled:opacity-50 disabled:cursor-not-allowed rounded-lg py-3 px-4 text-white font-medium transition-colors"
            >
              {isLoadingFacebook ? (
                <svg className="animate-spin w-5 h-5" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
