...
export default function Step2Consumption() {
  ...
  const [monthlyBill, setMonthlyBill] = useState<number | null>(state.monthlyBill || 215);
  ...
  return (
    <div className="max-w-xl mx-auto pb-24">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-[#0a0a0a] pb-[max(0px,env(safe-area-inset-bottom))]">
        {/* Amber glow divider */}
