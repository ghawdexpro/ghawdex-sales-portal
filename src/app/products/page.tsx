...
const PRODUCTS: Product[] = [
  // Solar Systems
  {
    ...
    category: 'solar',
    price: 3750,
    description: 'Perfect starter system for apartments and small homes',
    specs: {
      'System Size': '5 kWp',
      'Panels': '10 panels (450W)',
      'Roof Area': '~20 m²',
      'Daily Production': '~25 kWh',
    },
    annualProduction: 9000,
    annualIncome: 1350,
    bestFor: ['Small households', 'Apartments', 'Budget-conscious'],
    homeSize: ['apartment', 'small'],
  },
  {
    id: 'solar-6kw',
    name: '6 kWp Solar System',
    category: 'solar',
    price: 4500,
    description: 'Maximum single-phase capacity for average homes',
    specs: {
      'System Size': '6 kWp',
      'Panels': '12 panels (450W)',
      'Roof Area': '~24 m²',
      'Daily Production': '~30 kWh',
    },
    annualProduction: 10800,
    annualIncome: 1620,
    bestFor: ['Average households', 'Single-phase max'],
    homeSize: ['small', 'medium'],
    popular: true,
  },
  {
    id: 'solar-8kw',
    name: '8 kWp Solar System',
    category: 'solar',
    price: 6000,
    description: 'Three-phase system for medium to large homes',
    specs: {
      'System Size': '8 kWp',
      'Panels': '~18 panels (450W)',
      'Roof Area': '~32 m²',
      'Daily Production': '~40 kWh',
    },
    annualProduction: 14400,
    annualIncome: 2160,
    bestFor: ['Medium-large homes', 'Growing families'],
    homeSize: ['medium', 'large'],
  },
  {
    id: 'solar-10kw',
    ...
    category: 'solar',
    price: 7500,
    description: 'Popular choice for large homes with high consumption',
    specs: {
      'System Size': '10 kWp',
      'Panels': '~22 panels (450W)',
      'Roof Area': '~40 m²',
      'Daily Production': '~50 kWh',
    },
  ...
  {
    id: 'solar-12kw',
    name: '12 kWp Solar System',
    category: 'solar',
    price: 9000,
    description: 'Ideal for pool owners and heavy AC users',
    specs: {
      'System Size': '12 kWp',
      'Panels': '~27 panels (450W)',
      'Roof Area': '~48 m²',
      'Daily Production': '~60 kWh',
    },
    annualProduction: 21600,
    annualIncome: 3240,
    bestFor: ['Large homes', 'Pool owners', 'Heavy A/C usage'],
  ...
  },
  {
    ...
    category: 'solar',
    price: 11250,
    description: 'Premium system for villas and large families',
    specs: {
      'System Size': '15 kWp',
      'Panels': '~33 panels (450W)',
      'Roof Area': '~60 m²',
      'Daily Production': '~74 kWh',
    },
    annualProduction: 27000,
    annualIncome: 4050,
    bestFor: ['Villas', 'Large families', 'Multiple A/C'],
    homeSize: ['villa'],
  },
  {
    id: 'solar-20kw',
    name: '20 kWp Solar System',
    category: 'solar',
    price: 15000,
    description: 'Maximum income system for large properties',
    specs: {
      'System Size': '20 kWp',
      'Panels': '~44 panels (450W)',
      'Roof Area': '~80 m²',
      'Daily Production': '~99 kWh',
    },
    annualProduction: 36000,
    annualIncome: 5400,
    bestFor: ['Maximum income', 'Large properties', 'Farmhouses'],
    homeSize: ['villa'],
    popular: true,
  },
  // Batteries
  ...
  // Bundles
  {
    ...
    category: 'bundle',
    price: 9500,
    description: '6 kWp + 5 kWh battery + EMS - Save €1,000',
    specs: {
      'PV System': '6 kWp',
      'Battery': '5 kWh',
      'EMS': 'Standard',
    ...
    bestFor: ['Small homes', 'Budget-conscious'],
    homeSize: ['apartment', 'small'],
  },
  {
    id: 'bundle-standard',
    ...
    category: 'bundle',
    price: 16500,
    description: '10 kWp + 10 kWh battery + EMS - Save €2,000',
    specs: {
      'PV System': '10 kWp',
      'Battery': '10 kWh',
      'EMS': 'Standard',
    ...
    bestFor: ['Average families', 'Good balance'],
    homeSize: ['medium', 'large'],
    popular: true,
  },
  {
    ...
    category: 'bundle',
    price: 25000,
    description: '15 kWp + 15 kWh battery + Premium EMS - Save €3,250',
    specs: {
      'PV System': '15 kWp',
      'Battery': '15 kWh',
      'EMS': 'Premium',
  ...
  {
    id: 'bundle-max',
    name: 'Max Independence Bundle',
    category: 'bundle',
    price: 42000,
    description: '20 kWp + 30 kWh battery + Premium EMS - Save €5,000',
    specs: {
      'PV System': '20 kWp',
      'Battery': '30 kWh',
      'EMS': 'Premium',
    ...
    annualProduction: 36000,
    savings: '~85% self-consumption',
    bestFor: ['Complete independence', 'Large properties'],
    homeSize: ['villa'],
  },
  // Add-ons
  {
